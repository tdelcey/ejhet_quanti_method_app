...
# ------------------------------------------------------------
backbone_network <- read_rds(here("data_raw", "backbone_network.rds"))
window_levels <- read_rds(here("data", "window_levels.rds"))
comm_levels <- read_rds(here("data_raw", "comm_levels.rds"))
cluster_colors <- read_rds(here("data_raw", "cluster_colors.rds"))
...
write_rds(
  ...
  here("data_raw", "temporal_backbone_network.rds")
)
